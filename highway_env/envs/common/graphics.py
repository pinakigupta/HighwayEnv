    ...
    def display(self) -> None:
        ...
        pygame.display.set_caption(
                                   ...
                                   + f"{self.env.vehicle.speed:.2f}" 
                                    ...
                                    + " { " + str(self.env.vehicle.lane_index[2]) + " : " + str(self.env.vehicle.target_lane_index[2]) +  " : "  + str([idx[2] for idx in self.env.road.network.side_lanes(self.env.vehicle.lane_index)]) + " } "
                                  )
