...
class RoadGraphics(object):
    ...
    @staticmethod
    def display_traffic(road: Road, surface: WorldSurface, simulation_frequency: int = 15, label = False, offscreen: bool = False, **kwargs) \
            -> None:
        """
        ...
        for v in road.vehicles:
            VehicleGraphics.display(v, surface, offscreen=offscreen, label=label, **kwargs)
